...
export class Alerts extends Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (message !== prevProps.message) {
            ...
            if (message.fileDeleted) alert.success(message.fileDeleted);
            if (message.fileAdded) alert.success(message.fileAdded);
            if (message.passwordsNotMatch) alert.error(message.passwordsNotMatch);
            if (message.splitTotal) alert.error(message.splitTotal);
        }
    }
